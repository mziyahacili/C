...
VideoCard ::VideoCard(const VideoCard &other)  : Component(other) {
    ...
    this->memoryBits = other.memoryBits;
    this->ventilatorsCount = other.ventilatorsCount;
    this->internalVideoMemory = other.internalVideoMemory;
    this->graphicFamily = other.graphicFamily;
}
